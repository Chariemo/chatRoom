...
public class FriendView {
	...
	private DefaultMutableTreeNode dmtnOnlineUsersRoot = new DefaultMutableTreeNode("我的好友");

	private DefaultMutableTreeNode dmtnMyGroup = new DefaultMutableTreeNode("我的群");

	private DefaultMutableTreeNode dmtnUnknownUsers = new DefaultMutableTreeNode("陌生人");

	private DefaultMutableTreeNode dmtnBlackName = new DefaultMutableTreeNode("黑名单");
	...
	public void initView() {
		...
		jframeFriendList.setDefaultCloseOperation(jframeFriendList.EXIT_ON_CLOSE);
	...
	public void acctionListener() {
		...
		jtree.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				if (count != -1) {
					String strFriendUsername = jtree.getLastSelectedPathComponent().toString();
					if (e.getClickCount() == 2 && count != 0 && !strFriendUsername.equals("陌生人")
							&& !strFriendUsername.equals("黑名单") && !strFriendUsername.equals("我的群")) {
